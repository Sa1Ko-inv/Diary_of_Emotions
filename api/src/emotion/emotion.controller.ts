...
export class EmotionController {
  ...
  @Authorization()
  @ApiOperation({summary: 'Получение всех групп эмоций', description: 'Возвращает список всех групп эмоций с их типами'})
  ...
  @Authorization()
  @ApiOperation({summary: 'Получение всех эмоций', description: 'Возвращает список всех эмоций с их группами'})
  ...
  @Authorization()
  @ApiOperation({summary: 'Получение группы эмоций по ID', description: 'Возвращает группу эмоций по её уникальному идентификатору'})
  ...
  @Authorization()
  @ApiOperation({summary: 'Получение эмоции по ID', description: 'Возвращает эмоцию по его уникальному идентификатору'})
